...
class LearnPose(nn.Module):
    def __init__(self, num_cams, learn_R, learn_t, init_c2w=None):
        ...
        self.r = nn.Parameter(torch.rand(size=(num_cams, 3), dtype=torch.float32), requires_grad=learn_R)  # (N, 3)
        self.t = nn.Parameter(torch.rand(size=(num_cams, 3), dtype=torch.float32), requires_grad=learn_t)  # (N, 3)
